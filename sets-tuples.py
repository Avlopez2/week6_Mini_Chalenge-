...
print(set2)
print(set3)
print(set4) # duplicate elements are removed
...
print(len(set1)) # prints the length in each set

#clear a set
set1.clear()
print(set1)

id_numbers = {67568665, 76545568, 989755, 54696, 32456789} # sets print out in random order 
# remove first element from set
print(id_numbers) # output : {67568665, 76545568, 989755, 54696, 32456789}
id_numbers.pop 
print(id_numbers)
...
print(tuple1.index(3)) # counts the occurance of the number or word 
...
sample_list = [[1, 2, 3], [4, 5, 6], [7, 8, 9]] # nested list small list inside a bigger list 
# get length of the list
print(sample_list[0]) # out put [1, 2, 3],
print(sample_list[1])  # out put [4, 5, 6],
print(sample_list[2])  # out put [7, 8, 9]
...
sample_list_of_fruit = {"fruits": ["apple", "banana", "cherry"]} # {} = dictionar [] = list 
